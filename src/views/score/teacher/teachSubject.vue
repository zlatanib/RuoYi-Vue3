...
<!--    </el-form>-->
    ...
    <el-table v-loading="loading" :data="subjectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学科名称" prop="subjectName" :show-overflow-tooltip="true" />
      <el-table-column label="学科属性" align="center" prop="nature">
    ...
    <pagination
        ...
        @pagination="getList"
    />
    <select-subject ref="selectRef" :roleId="queryParams.roleId" @ok="handleQuery" />
  </div>
</template>

<script setup name="TeachSubject">
// TODO 修改
import selectSubject from "./selectSubject";
import { allocatedSubjectList } from "@/api/score/teacher";
...
function getList() {
  loading.value = true;
  allocatedSubjectList(queryParams).then(response => {
